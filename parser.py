from operation_codes import Opcodes, compress_bytes, arth_op, comp_op
from symbol import Symbol
import parser_util as Aux
from token_types import comparison_operators_list
        ...
        if sym_object:
            ...
            if self.curr_t[1] == "TK_LEFT_BRACKET":
                ...
                if exp_1 == sym_object.assignment_type:
                    ...
                    raise TypeError('Mismatched types: ' + exp_1 + ' and ' + sym_object.assignment_type)
                return
